...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        primary: ["PrimaryFont", "Cinzel", "serif"],
      ...
      backgroundImage: {
        ...
        "hero-gradient":
          "linear-gradient(180deg, hsl(240 30% 3%) 0%, hsl(260 40% 8%) 50%, hsl(280 35% 12%) 100%)",
        "gold-gradient": "linear-gradient(90deg, #e6ab26 0%, #91611f 100%)",
        "nebula-gradient":
          "linear-gradient(135deg, hsl(270 60% 50%) 0%, hsl(320 80% 55%) 100%)",
        "cosmic-gradient":
          "linear-gradient(135deg, hsl(220 80% 50%) 0%, hsl(270 60% 50%) 50%, hsl(320 80% 55%) 100%)",
      },
      boxShadow: {
        ...
        "glow-cosmic":
          "0 0 50px hsla(270, 60%, 50%, 0.3), 0 0 100px hsla(320, 80%, 55%, 0.2)",
      },
    },
  },
